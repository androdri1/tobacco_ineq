***************************************************************************
***************************************************************************
********Creación de Grupos de Gasto para Base 98 y 99 igual a punto********
***************************************************************************
***************************************************************************
...
use "C:\Documents and Settings\BAtuestaM\Mis documentos\Bernardo Atuesta\Darwin\Gasto ECV2008\StataFiles\VblesGasto_98y99igualpunto_ECV2008.dta"
...
gen educacion = ((1/12)*(p6169s1 + p8564s1 + p8566s1 + p8568s1)) + (p8570s1 + p8572s1 + p8574s1 + p8576s1) + ((30/7)*(p8578s2 + p8580s2 + p6180s2)) + ((1/12)*(p8594s1 + /*
...
gen total_gasto_hog_exp = total_gasto_hog*fex_ug



save "C:\Documents and Settings\BAtuestaM\Mis documentos\Bernardo Atuesta\Darwin\Gasto ECV2008\StataFiles\Gasto_Hogares_98y99punto_ECV2008.dta", replace
...
use "C:\Documents and Settings\BAtuestaM\Mis documentos\Bernardo Atuesta\Darwin\Gasto ECV2008\StataFiles\Gasto_Hogares_98y99punto_ECV2008.dta"
...
save "C:\Documents and Settings\BAtuestaM\Mis documentos\Bernardo Atuesta\Darwin\Gasto ECV2008\StataFiles\Gasto_percapita_Regiones_98y99punto_ECV2008.dta", replace
